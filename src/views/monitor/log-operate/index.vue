    ...
    >
      ...
      <el-table-column prop="logType" label="日志类型" width="90px">
        <template slot-scope="scope">
          ...
          <el-tag v-else-if="scope.row.logType === 'WARN'" type="warning">{{ scope.row.logType }}</el-tag>
      ...
      <el-table-column prop="time" label="执行时间" sortable="custom">
        <template slot-scope="scope">
          ...
          <el-tag v-else-if="scope.row.time <= 3000" type="warning">{{ scope.row.time }}ms</el-tag>
